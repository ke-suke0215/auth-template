...
export function NotFoundPage() {
  return (
    <AppShell>
      <section className="w-full max-w-md border-y border-[#E7E5E4] bg-[#FFFFFF] px-6 py-8 sm:px-8 sm:py-10" aria-labelledby="not-found-title">
        ...
        <p className="mt-4 text-sm leading-6 text-[#57534E]">指定されたページは存在しないか、移動された可能性があります。</p>
        <Link
          to="/"
